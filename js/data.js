...
const LESSONS = {
  ...
  creation: {
    ...
    video:"https://www.youtubekids.com/watch?v=teu7BCZTgDs",
    quiz:[
  ...
  adam_eve: {
    ...
    video:"https://www.youtubekids.com/watch?v=l7TDvJrjjz0",
    quiz:[
  ...
  noah: {
    ...
    video:"https://www.youtubekids.com/watch?v=Wbfp7fzhj4Y",
    quiz:[
  ...
  annunciation: {
    ...
    video:"https://www.youtubekids.com/watch?v=VrYvuYwPAvU",
    quiz:[
  ...
  nativity: {
    ...
    video:"https://www.youtubekids.com/watch?v=v3656G6tWuI",
    quiz:[
  ...
  good_sam: {
    ...
    video:"https://www.youtubekids.com/watch?v=osfQg4yKtq8",
    quiz:[
  ...
  resurrection: {
    ...
    video:"https://www.youtubekids.com/watch?v=ORKuFiAXCZs",
    quiz:[
  ...
  st_francis: {
    ...
    video:"https://www.youtubekids.com/watch?v=khXHWTxT5xA",
    quiz:[
  ...
  popes_today: {
    ...
    video:"https://www.youtubekids.com/watch?v=iTbJfDaneSI",
    quiz:[
...
Object.assign(LESSONS, {
  ...
  the_mass: {
    ...
    video:"https://www.youtubekids.com/watch?v=XGjF0rL5j_U",
    quiz:[
  ...
  mary_mother: {
    ...
    video:"https://www.youtubekids.com/watch?v=dIqY5oSiQyA",
    quiz:[
  ...
  hail_mary: {
    ...
    video:"https://www.youtubekids.com/watch?v=IlCIW-KeaW4",
    quiz:[
  ...
  immaculate: {
    ...
    video:"https://www.youtubekids.com/watch?v=YNuS3jVh8u4",
    quiz:[
  ...
  mary_visitation: {
    ...
    video:"https://www.youtubekids.com/watch?v=OY3iNQkWgvE",
    quiz:[
  ...
  mary_cross: {
    ...
    video:"https://www.youtubekids.com/watch?v=dxr-_y_PxX8",
    quiz:[
  ...
  mary_apostles: {
    ...
    video:"https://www.youtubekids.com/watch?v=vXyxMrmc9Qw",
    quiz:[
  ...
  guadalupe: {
    ...
    video:"https://www.youtubekids.com/watch?v=FI_gXWGmBNg",
    quiz:[
  ...
  lourdes: {
    ...
    video:"https://www.youtubekids.com/watch?v=-QbwjpgsiEU",
    quiz:[
  ...
  fatima: {
    ...
    video:"https://www.youtubekids.com/watch?v=LT0Jh7Oek7w",
    quiz:[
  ...
  rosary: {
    ...
    video:"https://www.youtubekids.com/watch?v=UnOAQp-ST6Q",
    quiz:[
  ...
  assumption: {
    ...
    video:"https://www.youtubekids.com/watch?v=mkuYhgDj_2A",
    quiz:[
  ...
  marian_feasts: {
    ...
    video:"https://www.youtubekids.com/watch?v=fEfUudwnyD0",
    quiz:[
  ...
  st_peter_paul: {
    ...
    verse:{ text:"You are Peter, and upon this rock I will build my Church.", ref:"Matthew 16:18" },
    video:"https://www.youtubekids.com/watch?v=R_ASHJiTc-I",
    quiz:[
  ...
  st_nicholas: {
    ...
    video:"https://www.youtubekids.com/watch?v=gfsGFHbCPCM",
    quiz:[
  ...
  st_lucy: {
    ...
    video:"https://www.youtubekids.com/watch?v=aBfXH85qRIk",
    quiz:[
  ...
  st_george: {
    ...
    video:"https://www.youtubekids.com/watch?v=Xee5onUpFUY",
    quiz:[
  ...
  st_joan: {
    ...
    video:"https://www.youtubekids.com/watch?v=QtRZmqk2J5o",
    quiz:[
  ...
  st_sebastian: {
    ...
    video:"https://www.youtubekids.com/watch?v=EEes6-WgUds",
    quiz:[
  ...
  st_clare: {
    ...
    video:"https://www.youtubekids.com/watch?v=XHVwHGiKLEo",
    quiz:[
  ...
  st_anthony: {
    ...
    video:"https://www.youtubekids.com/watch?v=SjL9ObnDRaM",
    quiz:[
  ...
  st_therese: {
    ...
    video:"https://www.youtubekids.com/watch?v=hx8fzZXyTIw",
    quiz:[
  ...
  st_augustine: {
    ...
    video:"https://www.youtubekids.com/watch?v=9wxEFQYIH6o",
    quiz:[
  ...
  st_aquinas: {
    ...
    video:"https://www.youtubekids.com/watch?v=hF-C5nZfMUI",
    quiz:[
  ...
  st_lorenzo: {
    ...
    video:"https://www.youtubekids.com/watch?v=vx4mlI3_rDw",
    quiz:[
  ...
  st_pedro: {
    ...
    video:"https://www.youtubekids.com/watch?v=r74tUbmCv6I",
    quiz:[
  ...
  mother_teresa: {
    ...
    video:"https://www.youtubekids.com/watch?v=dxNgoBpvs-k",
    quiz:[
  ...
  st_pio: {
    ...
    video:"https://www.youtubekids.com/watch?v=cLOIx_ux400",
    quiz:[
  ...
  st_carlo: {
    ...
    video:"https://www.youtubekids.com/watch?v=Zwz0USG-7W4",
    quiz:[
